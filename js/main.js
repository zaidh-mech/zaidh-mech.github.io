    ...
    * ------------------------------------------------------ */
    const ssContactUX = function() {
        ...
        copyBtn.addEventListener('click', async function () {
            ...
            copyBtn.textContent = copied ? 'Copied!' : 'Copy failed — click to mail';
            if (!copied && email) {
                // on failure, fall back to mailto after a short delay
                setTimeout(function(){ window.location.href = 'mailto:' + email; }, 600);
            }
